...
await cdp.send('HeapProfiler.collectGarbage');const before=(await cdp.send('Performance.getMetrics')).metrics;
...
r.status=r.lateStarts===0&&r.maxSkewSamples<=1&&r.active===0&&r.lit===0&&r.marked===0&&errors.length===0?'PASS':'FAIL';
